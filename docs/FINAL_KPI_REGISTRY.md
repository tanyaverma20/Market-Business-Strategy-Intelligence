...
| **16. Product Portfolio HHI** | `SUM(POW(mfg_share_pct, 2))` | Python, SQL, DAX, Excel | `dim_manufacturer` | **VERIFIED** | `[Product Portfolio HHI]` | Herfindahl Index of product catalog offering breadth. |
